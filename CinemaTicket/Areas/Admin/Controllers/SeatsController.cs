...
namespace CinemaTicket.Areas.Admin.Controllers
{
    ...
    public class SeatsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "SeatId,SeatNo,Status,Price")] Seat seat)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "SeatId,SeatNo,Status,Price")] Seat seat)
        {
            if (ModelState.IsValid)
            {
