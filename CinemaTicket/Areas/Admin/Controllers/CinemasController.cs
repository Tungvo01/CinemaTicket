...
namespace CinemaTicket.Areas.Admin.Controllers
{
    ...
    public class CinemasController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CinemaId,CinemaName,Description")] Cinema cinema)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CinemaId,CinemaName,Description")] Cinema cinema)
        {
            if (ModelState.IsValid)
            {
